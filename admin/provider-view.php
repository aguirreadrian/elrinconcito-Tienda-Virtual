<p class="lead">
Bienvenido al Panel de Administración de Proveedores. Aquí puedes gestionar los proveedores de El Rinconsito para garantizar un suministro fluido y eficiente de productos.</p>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group label-floating">
                                    <label class="control-label">CUIL/CUIT</label>
