    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>Regístrate en 'El Rinconsito'</small></h1>
            </div>
            <p class="lead text-center">
¡Bienvenido a 'El Rinconsito', donde la pasión por los libros cobra vida! Al registrarte, no solo te conviertes en un cliente, sino en un miembro valioso de nuestra comunidad literaria.            </p>
            <div class="row">
